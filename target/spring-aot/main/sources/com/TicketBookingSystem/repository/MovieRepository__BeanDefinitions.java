...
/**
 * Bean definitions for {@link MovieRepository}.
 */
@Generated
public class MovieRepository__BeanDefinitions {
  /**
   * Get the bean instance supplier for 'movieRepository'.
   */
  private static BeanInstanceSupplier<JpaRepositoryFactoryBean> getMovieRepositoryInstanceSupplier(
      ) {
  ...
  /**
   * Get the bean definition for 'movieRepository'.
   */
  public static BeanDefinition getMovieRepositoryBeanDefinition() {
    RootBeanDefinition beanDefinition = new RootBeanDefinition(JpaRepositoryFactoryBean.class);
    beanDefinition.setTargetType(ResolvableType.forClassWithGenerics(JpaRepositoryFactoryBean.class, MovieRepository.class, Movie.class, Long.class));
    beanDefinition.setLazyInit(false);
    beanDefinition.getConstructorArgumentValues().addIndexedArgumentValue(0, "com.TicketBookingSystem.repository.MovieRepository");
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragments", new RuntimeBeanReference("jpa.MovieRepository.fragments#0"));
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragmentsFunction", new RepositoryFactoryBeanSupport.RepositoryFragmentsFunction() {
      public RepositoryComposition.RepositoryFragments getRepositoryFragments(
        ...
        return RepositoryComposition.RepositoryFragments.just(new com.TicketBookingSystem.repository.MovieRepositoryImpl__AotRepository(entityManager, context));
      }
    });
    InstanceSupplier<JpaRepositoryFactoryBean> instanceSupplier = getMovieRepositoryInstanceSupplier();
