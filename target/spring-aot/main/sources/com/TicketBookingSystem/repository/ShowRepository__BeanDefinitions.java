...
/**
 * Bean definitions for {@link ShowRepository}.
 */
@Generated
public class ShowRepository__BeanDefinitions {
  /**
   * Get the bean instance supplier for 'showRepository'.
   */
  private static BeanInstanceSupplier<JpaRepositoryFactoryBean> getShowRepositoryInstanceSupplier(
      ) {
  ...
  /**
   * Get the bean definition for 'showRepository'.
   */
  public static BeanDefinition getShowRepositoryBeanDefinition() {
    RootBeanDefinition beanDefinition = new RootBeanDefinition(JpaRepositoryFactoryBean.class);
    beanDefinition.setTargetType(ResolvableType.forClassWithGenerics(JpaRepositoryFactoryBean.class, ShowRepository.class, Show.class, Long.class));
    beanDefinition.setLazyInit(false);
    beanDefinition.getConstructorArgumentValues().addIndexedArgumentValue(0, "com.TicketBookingSystem.repository.ShowRepository");
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragments", new RuntimeBeanReference("jpa.ShowRepository.fragments#0"));
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragmentsFunction", new RepositoryFactoryBeanSupport.RepositoryFragmentsFunction() {
      public RepositoryComposition.RepositoryFragments getRepositoryFragments(
        ...
        return RepositoryComposition.RepositoryFragments.just(new com.TicketBookingSystem.repository.ShowRepositoryImpl__AotRepository(entityManager, context));
      }
    });
    InstanceSupplier<JpaRepositoryFactoryBean> instanceSupplier = getShowRepositoryInstanceSupplier();
