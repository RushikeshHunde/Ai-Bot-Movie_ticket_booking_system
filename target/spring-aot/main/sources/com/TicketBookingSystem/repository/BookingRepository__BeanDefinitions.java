...
public class BookingRepository__BeanDefinitions {
  ...
  public static BeanDefinition getBookingRepositoryBeanDefinition() {
    ...
    beanDefinition.getConstructorArgumentValues().addIndexedArgumentValue(0, "com.TicketBookingSystem.repository.BookingRepository");
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragmentsFunction", new RepositoryFactoryBeanSupport.RepositoryFragmentsFunction() {
      public RepositoryComposition.RepositoryFragments getRepositoryFragments(
        ...
        return RepositoryComposition.RepositoryFragments.just(new com.TicketBookingSystem.repository.BookingRepositoryImpl__AotRepository(entityManager, context));
      }
    });
