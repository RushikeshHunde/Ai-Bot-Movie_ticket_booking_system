...
/**
 * Bean definitions for {@link TicketRepository}.
 */
@Generated
public class TicketRepository__BeanDefinitions {
  /**
   * Get the bean instance supplier for 'ticketRepository'.
   */
  private static BeanInstanceSupplier<JpaRepositoryFactoryBean> getTicketRepositoryInstanceSupplier(
      ) {
  ...
  /**
   * Get the bean definition for 'ticketRepository'.
   */
  public static BeanDefinition getTicketRepositoryBeanDefinition() {
    RootBeanDefinition beanDefinition = new RootBeanDefinition(JpaRepositoryFactoryBean.class);
    beanDefinition.setTargetType(ResolvableType.forClassWithGenerics(JpaRepositoryFactoryBean.class, TicketRepository.class, Ticket.class, String.class));
    beanDefinition.setLazyInit(false);
    beanDefinition.getConstructorArgumentValues().addIndexedArgumentValue(0, "com.TicketBookingSystem.repository.TicketRepository");
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragments", new RuntimeBeanReference("jpa.TicketRepository.fragments#0"));
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragmentsFunction", new RepositoryFactoryBeanSupport.RepositoryFragmentsFunction() {
      public RepositoryComposition.RepositoryFragments getRepositoryFragments(
        ...
        return RepositoryComposition.RepositoryFragments.just(new com.TicketBookingSystem.repository.TicketRepositoryImpl__AotRepository(entityManager, context));
      }
    });
    InstanceSupplier<JpaRepositoryFactoryBean> instanceSupplier = getTicketRepositoryInstanceSupplier();
