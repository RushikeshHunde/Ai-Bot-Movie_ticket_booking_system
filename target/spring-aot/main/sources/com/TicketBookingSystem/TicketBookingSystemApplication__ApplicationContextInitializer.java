 ...
 */
@Generated
public class TicketBookingSystemApplication__ApplicationContextInitializer implements ApplicationContextInitializer<GenericApplicationContext> {
  @Override
  public void initialize(GenericApplicationContext applicationContext) {
    ...
    new TicketBookingSystemApplication__BeanFactoryRegistrations().registerBeanDefinitions(beanFactory);
    new TicketBookingSystemApplication__BeanFactoryRegistrations().registerAliases(beanFactory);
  }
